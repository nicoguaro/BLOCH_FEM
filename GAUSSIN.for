...
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
C                                                                      C
C     SUBROUTINE GPOINTS3                                              C
C                                                                      C
C     3 GAUSS POINTS FOR TRIANGULAR DOMAINS                            C
C                                                                      C
C                                                                      C
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
C23456789012345678901234567890123456789012345678901234567890123456789012
C
      SUBROUTINE GPOINTS3(XP,XW)
C
      IMPLICIT REAL*8 (A-H,O-Z)
C
      PARAMETER (ZERO=0.D0,ONE=1.D0,HALF=0.5D0)
C
      DIMENSION XP(2,3),XW(3)
C
      CALL CLEARV(XW,3)
      CALL CLEAR(XP,2,3)
C

      XW(1)=0.3333333333333D0
      XW(2)=XW(1)
      XW(3)=XW(1)
C
      XP(1,1)= 0.1666666666667D0
      XP(1,2)= 0.6666666666667D0
      XP(1,3)= XP(1,1)
C
      XP(2,1)= XP(1,1)
      XP(2,2)= XP(1,1)
